...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='FilerImage',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(on_delete=models.CASCADE,on_delete=models.CASCADE,parent_link=True, auto_created=True, primary_key=True, serialize=False, to='cms.CMSPlugin')),
